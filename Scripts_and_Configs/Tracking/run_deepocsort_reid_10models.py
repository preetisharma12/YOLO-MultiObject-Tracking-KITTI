import sys
sys.path.append("/data/pool/bhe-mk3/python_packages/lib/python3.10/site-packages")
...
reid_path = "/data/pool/bhe-mk3/reid_weights/osnet_x0_25_msmt17.pt"

seq_root = Path(
    "/data/pool/bhe-mk3/kitti_tracking/training/image_02"
)
...
for model_name, model_path in models.items():
    ...
    print("\n" + "=" * 80)
    print(f"RUNNING DEEPOCSORT-REID : {model_name}")
    print("=" * 80)

    out_root = Path(
        f"/data/pool/bhe-mk3/kitti_tracking/deepocsort_reid_{model_name}"
    )
